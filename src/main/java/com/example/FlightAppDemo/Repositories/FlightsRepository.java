...
public interface FlightsRepository extends JpaRepository<Flight, String> {
    ...
    @Query(value = "INSERT INTO \"flights\" (id, place_of_departure, destination, departure_time, arrival_time, price) VALUES \n" +
            ...
            "(SELECT id from \"airports\" WHERE city = :#{#flightDto.place_of_departure} LIMIT 1), " +
            "(SELECT id from \"airports\" WHERE city = :#{#flightDto.destination} LIMIT 1), " +
    ...
    int updateFlight(@Param("flightDto") FlightDTO flightDto);
